...
process_date <- as.Date("2020-8-10")

population <- 2330048 # 2020/7/1

nagoya_city_covid19 <- read_csv("nagoya_city_covid19(20200810).csv", 
...
```{r}
pop <- as.vector(table(c(seq(0,90,10), nagoya$年代[nagoya$発表日 > process_date - 7]))) - 1
pop_m <- as.vector(table(c(seq(0,90,10), nagoya$年代[nagoya$性別 == "男性" & nagoya$発表日 > process_date - 7]))) - 1
pop_f <- as.vector(table(c(seq(0,90,10), nagoya$年代[nagoya$性別 == "女性" & nagoya$発表日 > process_date - 7]))) - 1
...
knitr::kable(symptom, col.names = c("症状", "20歳未満", "20-30歳代", "40-50歳代", "60-70歳代", "80歳以上"))
```
